# cy_usb_bulkloop
This directory is a demo of Simulating a `Cypress FX2` device on Sipeed [Tang MEGA 138K Pro](https://wiki.sipeed.com/hardware/en/tang/tang-mega-138k/mega-138k-pro.html). The main purpose of this demo is to use the **Cypress C++ Bulkloop** to conduct a transmit & receive stability test of GOWIN's **SOFT_USB2**.
