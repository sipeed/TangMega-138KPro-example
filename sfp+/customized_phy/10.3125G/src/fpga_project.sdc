...
create_clock -name q1_ln0_rx_clk -period 10 -waveform {0 5} [get_nets {Customized_PHY_Top_q1_ln0_rx_pcs_clkout_o}]
create_clock -name q1_ln0_tx_clk -period 10 -waveform {0 5} [get_nets {Customized_PHY_Top_q1_ln0_tx_pcs_clkout_o}]
...
set_clock_groups -asynchronous -group [get_clocks {tck_pad_i}] -group [get_clocks {q1_ln0_rx_clk}]
set_clock_groups -asynchronous -group [get_clocks {q1_ln0_rx_clk}] -group [get_clocks {q1_ln0_tx_clk}]
